@test
Feature: Women Category Functionality Test

  Scenario: I should navigate to WomenCategory page successfully
    Given I am on homepage
    When I click on Women link
    Then I should see the women message "Women"

  Scenario Outline: I should AddProductToTheCartSuccessfully
    Given I am on homepage
    When I click on Women link
