...
public class ProductPage extends Utility {
    ...
    public void clickOnPlus() {
        ...
        log.info("Clicking on AddQuntity Button: " + addQuntity.toString());

    }

    public void clearQuantity() {
        log.info("Clearing the Quantity: " + quantity.toString());
        clearTextToElement(quantity);
    }

    public void enterQuantity(String number) {
        sendTextToElement(quantity, number);
        log.info("Enter Quantity: " + number+ quantity.toString() );
    }
